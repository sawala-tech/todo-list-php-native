        ...
        <div class="w-full max-w-[650px] p-6 bg-white rounded-2xl shadow-lg flex flex-col space-y-6">
            ...
            <form class="flex flex-col space-y-4" action="<?= url('dashboard') ?>" method="POST" enctype="multipart/form-data">
                <div class="flex items-center space-x-2">
                    ...
                    <input type="text" class="w-3/4 h-10 px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500" placeholder="Judul Tugas" name="title" />
                </div>
                <div class="flex items-center space-x-2">
                    <label class="w-1/4 text-sm font-semibold">Deskripsi</label>
                    <textarea class="w-3/4 min-h-20 px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500" placeholder="Deskripsi Tugas" name="description"></textarea>
                </div>
                <div class="flex items-center space-x-2">
                    <label class="w-1/4 text-sm font-semibold">Tenggat Waktu</label>
                    <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="w-3/4 h-10 px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer" placeholder="Pilih Tanggal" name="deadline" />
                </div>
                <div class="flex items-center space-x-2">
                    <label class="w-1/4 text-sm font-semibold">Lampiran/File</label>
                    <input type="file" class="w-3/4 h-10 px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500" name="attachment" />
                </div>
                <div class="flex items-center space-x-2">
                    <label class="w-1/4">Status</label>
                    <select class="w-3/4 h-10 px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm" name="status">
